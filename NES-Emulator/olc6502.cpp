...
//--Bus Connectivity Functions implementation
...
void olc6502::clock() {
	if (cycles == 0) {
		...
		//Get the count of number of cycles
		cycles = lookup[opcode].cycles;

		uint8_t additional_cycle1 = (this->*lookup[opcode].addrmode)(); //--calling the function pointer
		uint8_t additional_cycle2 = (this->*lookup[opcode].operate)(); //--callin the function pointer

		//--If it need additional clock cycle
		cycles += (additional_cycle1 & additional_cycle2);
	}
	cycles--;
}

//--External Input Pins implementation
void olc6502::reset()
{
...
//--Adressing Modes
uint8_t olc6502::IMP() {
	fetched = a; //--data from accumaltor ?
	return 0;
}
...
//--Indirecting Address these are pointer
uint8_t olc6502::IND()
{
...
//--We first need to fetch the data
//--Fetch function
...
//--function captures illegal opcodes
uint8_t olc6502::XXX()
{
	return 0;
}
